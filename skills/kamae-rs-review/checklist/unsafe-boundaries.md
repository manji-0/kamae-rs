...
## 8.1 Is unsafe absent from domain logic? - High
...
## 8.2 Is unsafe contained behind a safe abstraction? - High
...
## 8.3 Are safety invariants documented at the unsafe site? - Medium
...
## 8.4 Can unsafe bypass domain construction or redaction? - High
...
## 8.5 Are unsafe boundaries tested with appropriate tools? - Medium
