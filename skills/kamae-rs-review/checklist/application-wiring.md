...
## 12.1 Are ports small and use-case shaped? - Medium
...
## 12.2 Do use cases depend on ports, not concrete adapters? - High
...
## 12.3 Is orchestration kept in use-case structs? - Medium
...
## 12.4 Are dependencies injected explicitly? - Low
...
## 12.5 Do tests swap ports instead of hitting real infrastructure? - Low
